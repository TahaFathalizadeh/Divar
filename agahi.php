...
if (isset($_POST['title']) && isset($_POST['karkard'])){
$title=$_POST['title'];
$karkard=$_POST['karkard'];
$price=$_POST['price'];
$image_name=$_POST['image_name'];

$time='دقایقی پیش در تهران';

$image_name2='uploads/'. $image_name;

$sql = mysqli_query($db, " 

insert into product (title, karkard,price,time,image) values ('$title' , '$karkard' , '$price', '$time', '$image_name2')  
...
<p   class="lb_divar">عنوان:</p> 
    ...
    border: 1px solid #eeeeee;">
        ...
        <input type="text" value="<?php echo $title; ?>" name="title" placeholder="عنوان آگهی" maxlength="100" class="in_divar">
